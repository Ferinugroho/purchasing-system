...
$sql1=mysql_query("insert into order_barang set id_barang='$kode_barang', nama_barang='$nama_stok', jumlah_barang='$jumlah_barang',       	    keterangan='$keterangan', tanggal_pemesanan='$tanggal_pesan'");
echo mysql_error();
