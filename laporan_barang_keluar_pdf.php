<page backtop="1,3mm" backbottom="1,3mm" backleft="1,3mm" backright="1,3mm"> 
		...
		?>
		<div>
        <img src="login/images/logoptsb.png" width="126" height="79" style="float:left" />
		<h2 style="text-align:center;">LAPORAN BARANG KELUAR <br> 
		  Per <?php echo $_GET['tanggal'];?> <?php echo $m;?> <?php echo $_GET['tahun'];?></h2>
