...
?>
<h4><i class="fa fa-plus"></i> Tambah Barang Keluar</h4>
<br>
<div class="row">
    <div class="col-md-5">
        <form class="form-horizontal" action="tambah_barang_keluar_save.php" method="post">
      <div id="barang_masuk">  
            ...
            <div class="form-group">
          	...
          	<div class="form-group">
            <label for="tgl_keluar" class="col-sm-5 control-label">Tgl. Keluar</label>
            <div class="col-sm-7">
              <input type="text" name="tgl_keluar" class="form-control" id="tgl_keluar" placeholder="Tgl Keluar">
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-offset-5 col-sm-7">
              ...
              <a href="main.php?p=barangkeluar"><button type="button" class="btn btn-danger"><i class="fa fa-remove"></i> Batal</button></a>
            </div>
          </div>
        </form>
    </div>
