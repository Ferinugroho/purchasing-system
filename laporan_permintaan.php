...
?>
<h3><i class="fa fa-file"></i> LAPORAN PERMINTAAN BAHAN BAKU</h3>
<br>
<div class="row">
    ...
    <form class="form-inline" method="get">
      ...
      <div class="form-group">
          ...
          <select class="form-control" name="tanggal" id="tanggal">
            ...
            <?php
            $sql_tgl = "SELECT DISTINCT DAY(tgl_permintaan) AS tanggal FROM permintaan";
      ...
      <div class="form-group">
          <select class="form-control" name="bulan" id="bulan">
            <option value="">[Pilih Bulan]</option>
             <?php
             $sql_bln = "SELECT DISTINCT MONTH(tgl_permintaan) AS bulan FROM permintaan";
      ...
      <div class="form-group">
          <select class="form-control" name="tahun" id="tahun">
            <option value="">[Pilih Tahun]</option>
             <?php
             $sql_thn = "SELECT DISTINCT YEAR(tgl_permintaan) AS tahun FROM permintaan";
      ...
      <a href="laporan_cetak_permintaan.php?tanggal=<?php echo $_GET['tanggal'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>" target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</button></a>
    </form>
  </div>
</div>
<br>
    ...
    <table class="table table-bordered">
      ...
      <?php
        ...
        if(!empty($tanggal) AND !empty($bulan) AND !empty($tahun)){
          $statement = " WHERE DAY(tgl_permintaan) = '$tanggal' AND MONTH(tgl_permintaan) = '$bulan' AND YEAR(tgl_permintaan) = '$tahun'";
        }elseif(empty($tanggal) AND !empty($bulan) AND !empty($tahun)){
          $statement = " WHERE MONTH(tgl_permintaan) = '$bulan' AND YEAR(tgl_permintaan) = '$tahun'";
        }elseif(empty($tanggal) AND empty($bulan) AND !empty($tahun)){
          $statement = " WHERE YEAR(tgl_permintaan) = '$tahun'";
        }
        $sql = "SELECT * $table";
