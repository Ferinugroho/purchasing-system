...
?>
<h3><i class="fa fa-file"></i> LAPORAN ORDER REQUEST</h3>
<br>
<div class="row">
    ...
    <form class="form-inline" method="get">
      ...
      <div class="form-group">
          ...
          <select class="form-control" name="tanggal" id="tanggal">
            ...
            <?php
            $sql_tgl = "SELECT DISTINCT DAY(tanggal_pemesanan) AS tanggal FROM order_barang";
      ...
      <div class="form-group">
          <select class="form-control" name="bulan" id="bulan">
            <option value="">[Pilih Bulan]</option>
             <?php
             $sql_bln = "SELECT DISTINCT MONTH(tanggal_pemesanan) AS bulan FROM order_barang";
      ...
      <div class="form-group">
          <select class="form-control" name="tahun" id="tahun">
            <option value="">[Pilih Tahun]</option>
             <?php
             $sql_thn = "SELECT DISTINCT YEAR(tanggal_pemesanan) AS tahun FROM order_barang";
      ...
      <a href="laporan_cetak_order_request.php?tanggal=<?php echo $_GET['tanggal'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>" target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</button></a>
    </form>
  </div>
</div>
<br>
    ...
    <table class="table table-bordered">
      ...
      <?php
        ...
        if(!empty($tanggal) AND !empty($bulan) AND !empty($tahun)){
          $statement = " WHERE DAY(tanggal_pemesanan) = '$tanggal' AND MONTH(tanggal_pemesanan) = '$bulan' AND YEAR(tanggal_pemesanan) = '$tahun'";
        }elseif(empty($tanggal) AND !empty($bulan) AND !empty($tahun)){
          $statement = " WHERE MONTH(tanggal_pemesanan) = '$bulan' AND YEAR(tanggal_pemesanan) = '$tahun'";
        }elseif(empty($tanggal) AND empty($bulan) AND !empty($tahun)){
          $statement = " WHERE YEAR(tanggal_pemesanan) = '$tahun'";
        }
        $sql = "SELECT * $table";
