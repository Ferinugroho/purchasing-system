...
?>
<h3><i class="fa fa-file"></i> LAPORAN BARANG MASUK</h3>
<br>
<div class="row">
    ...
    <form class="form-inline" method="get">
      ...
      <div class="form-group">
          ...
          <select class="form-control" name="tanggal" id="tanggal">
            ...
            <?php
            $sql_tgl = "SELECT DISTINCT DAY(tanggal_masuk) AS tanggal FROM barang_masuk";
      ...
      <div class="form-group">
          <select class="form-control" name="bulan" id="bulan">
            <option value="">[Pilih Bulan]</option>
             <?php
             $sql_bln = "SELECT DISTINCT MONTH(tanggal_masuk) AS bulan FROM barang_masuk";
      ...
      <div class="form-group">
          <select class="form-control" name="tahun" id="tahun">
            <option value="">[Pilih Tahun]</option>
             <?php
             $sql_thn = "SELECT DISTINCT YEAR(tanggal_masuk) AS tahun FROM barang_masuk";
      ...
      <a href="laporan_cetak_barang_masuk.php?tanggal=<?php echo $_GET['tanggal'];?>&bulan=<?php echo $_GET['bulan'];?>&tahun=<?php echo $_GET['tahun'];?>" target="_blank"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i> Cetak</button></a>
    </form>
  </div>
</div>
<br>
